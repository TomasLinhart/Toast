...
- (UIView *)makeToast:(NSString *)message duration:(CGFloat)interval position:(id)position title:(NSString *)title
{
...
- (UIView *)makeToast:(NSString *)message duration:(CGFloat)interval position:(id)position image:(UIImage *)image
{
...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point
{
    ...
    [UIView animateWithDuration:CSToastFadeDuration
        ...
        [UIView animateWithDuration:CSToastFadeDuration
                ...
                animations:^{
                    toast.alpha = 0.0;
                } completion:^(BOOL anotherFinished) {
